#!/usr/bin/env node
/**
 * Screenshot capture for Availability Success V3.4 final editorial closure.
 */
...
const OUT = join(process.cwd(), "docs/handoff/screenshots/availability-success-v3-4");
...
async function main() {
  ...
  try {
    ...
    console.log(`V3.4 screenshots saved to ${OUT}`);
  } finally {
    await browser.close();
  }
}
