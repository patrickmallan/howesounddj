#!/usr/bin/env node
/**
 * Screenshot capture for Availability Success V3.3 composition cohesion.
 */
...
const OUT = join(process.cwd(), "docs/handoff/screenshots/availability-success-v3-3");
...
async function main() {
  ...
  try {
    ...
    console.log(`V3.3 screenshots saved to ${OUT}`);
  } finally {
    await browser.close();
  }
}
