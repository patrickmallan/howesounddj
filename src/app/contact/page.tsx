...
export const metadata: Metadata = {
  ...
  description:
    "Contact Howe Sound DJ — check availability for your Squamish or Sea-to-Sky wedding, share your date and venue, and start with a consultation or DJ chat.",
  openGraph: {
    title: "Contact & Availability | Howe Sound DJ",
    description:
      "Reach out with your wedding vision. Inquiry form for date, venue, guest count, services, and how you want the night to feel.",
    url: "/contact",
  },
    ...
    <main className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70">
              Let’s connect and talk about how to create the right musical experience for your wedding — and bring the day to life with sound that matches your celebration. Reach out with your date, venue, and wedding vision; the goal is a process that feels simple, clear, and human from the first message.
            </p>
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 lg:p-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-white/70">
              Patrick invites couples to book a consultation or a free DJ chat to walk through the wedding, the vision, and the kind of experience you want guests to remember. Planning is built around fast replies, clear communication, and zero guesswork — the same “seamless planning” couples name when they talk about feeling calm and supported.
            </p>
            <p className="mt-4 text-lg leading-8 text-white/70">
              From there, it is about fit: your story, your energy, your people — and whether Howe Sound DJ is the right partner for your Sea-to-Sky wedding.
            </p>
          </div>
        </div>
      </section>

      <section id="inquiry" className="scroll-mt-24 border-y border-white/10 bg-white/5">
        <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.05fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">Send a message</h2>
              <p className="mt-4 max-w-xl text-lg leading-8 text-white/70">
                Share what you know today — even if the plan is still taking shape. Whether your wedding is elegant and emotional or wild and unforgettable (or both), the first step is getting the basics on paper so the conversation can focus on music, flow, and sound.
              </p>
              <div className="mt-8 rounded-[1.5rem] border border-white/10 bg-neutral-950/60 p-6">
                ...
                <ul className="mt-4 space-y-2 text-sm leading-7 text-white/60">
                  <li className="flex gap-2">
                    ...
                    Wedding date (or season if you are still choosing)
                  </li>
                  <li className="flex gap-2">
                    <span className="text-amber-300/80">—</span>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-8 text-white/70">
            Patrick’s work is built around tailoring the event to the couple — understanding musical tastes and the atmosphere you want — not forcing you to have every timeline detail locked before you say hello. If you are early in planning, say so. If you already know your venue and rough headcount, that helps too.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 lg:px-8">
        <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-amber-300/10 to-white/5 p-8 lg:p-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-white/70">
              Check availability, skim packages if helpful, and send what you know. The goal is a clear path from inquiry to consultation to a wedding day that sounds and feels like you.
            </p>
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              <a
                href="#inquiry"
