...
const guides = [
  ...
  {
    slug: "how-to-choose-a-wedding-dj-in-squamish",
    title: "How to Choose a Wedding DJ in Squamish",
    summary:
      "What to ask about ceremony sound, reception flow, room-reading, red flags, and how the Atmosphere Arc and Roomflow Method show up in real planning.",
  },
] as const;
