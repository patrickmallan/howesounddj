...
export const VENUE_PAGES: readonly VenuePage[] = [
  {
    ...
    localExpertise: [
      ...
      "If your date and logistics line up, the next step is the same as the rest of the site: check availability and talk through fit, coverage, and how you want the night to feel.",
    ],
  },
  {
    slug: "cheekye-ranch",
  ...
  },
  {
    ...
    metaDescription:
      "Sitka Farms wedding DJ: Sea-to-Sky sound planning and personalized reception music near Squamish. Howe Sound DJ focuses on fit, flow, and a dance floor that matches your guests.",
    whyFit: [
  ...
  },
  {
    ...
    localExpertise: [
      ...
      "Start with availability and a fit conversation—then map music and timeline to the day you are actually planning.",
    ],
  },
  {
  ...
  },
  {
    ...
    localExpertise: [
      "Local Squamish nights are part of the same professional lane as larger weddings—fit and communication come first.",
